...
// ShaderBackground — generated by the 21st.dev Shader Builder ("Waves")
...
// Palette updated to rich deep blues, teals, and cyan tones instead of light white/cyan
const UNIFORMS = {
  colors: [
    [0.04, 0.10, 0.20], // Deep Navy Blue
    [0.08, 0.22, 0.38], // Rich Prussian Blue
    [0.12, 0.38, 0.52], // Ocean Steel Blue
    [0.16, 0.52, 0.62], // Cyan Teal Blue
    [0.22, 0.62, 0.72], // Vibrant Electric Blue
    [0.10, 0.30, 0.45], // Medium Cobalt
    [0.05, 0.15, 0.28], // Dark Sapphire
    [0.03, 0.08, 0.16], // Midnight Blue
  ...
  detail: 1.536,
  contrast: 1.158,
  brightness: -0.05, // Slightly darker tone for richer blues
  saturation: 1.15,
  hue: 0.0,
  vignette: 0.25,
  blur: 0.002,
